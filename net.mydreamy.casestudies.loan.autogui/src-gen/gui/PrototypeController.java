...
public class PrototypeController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		loanmanagementmodule_service = ServiceManager.createLoanManagementModule();
	...
	*/
	public void genereateOpInvariantPanel() {
		...
		//entities invariants
		entities = LoanManagementModuleImpl.opINVRelatedEntity.get("bookNewLoan");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		for (Entry<String, String> inv : service_invariants_map.entrySet()) {
			...
			if (serviceName.equals("LoanManagementModule")) {
				Label l = new Label(invname);
				l.setStyle("-fx-max-width: Infinity;" + 
						   "-fx-background-color: linear-gradient(to right, #7FFF00 0%, #F0FFFF 100%);" +
						   "-fx-padding: 6px;" +
		...
		//entities invariants
		entities = LoanManagementModuleImpl.opINVRelatedEntity.get("generateStandardPaymentNotice");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LoanManagementModuleImpl.opINVRelatedEntity.get("generateLateNotice");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LoanManagementModuleImpl.opINVRelatedEntity.get("loanPayment");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LoanManagementModuleImpl.opINVRelatedEntity.get("closeOutLoan");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = ThirdPartServicesImpl.opINVRelatedEntity.get("getCheckingAccountStatus");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		for (Entry<String, String> inv : service_invariants_map.entrySet()) {
			...
			if (serviceName.equals("ThirdPartServices")) {
				Label l = new Label(invname);
				l.setStyle("-fx-max-width: Infinity;" + 
						   "-fx-background-color: linear-gradient(to right, #7FFF00 0%, #F0FFFF 100%);" +
						   "-fx-padding: 6px;" +
		...
		//entities invariants
		entities = ThirdPartServicesImpl.opINVRelatedEntity.get("getCreditHistory");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = ThirdPartServicesImpl.opINVRelatedEntity.get("sendEmail");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = ThirdPartServicesImpl.opINVRelatedEntity.get("print");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = ThirdPartServicesImpl.opINVRelatedEntity.get("createLoanAccount");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = ThirdPartServicesImpl.opINVRelatedEntity.get("transferFunds");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
	...
	*/ 
	...
	public void prepareData() {
		...
		definitions_map.put("enterLoanInformation", "loanrequest:LoanRequest = LoanRequest.allInstance()->any(loa:LoanRequest | loa.RequestID = requestid)\n");
		definitions_map.put("listSubmitedLoanRequest", "rs:Set(LoanRequest) = LoanRequest.allInstance()->select(r:LoanRequest | r.Status =  LoanRequestStatus :: SUBMITTED)\n");
		definitions_map.put("chooseLoanRequest", "rs:LoanRequest = self.CurrentLoanRequests->any(r:LoanRequest | r.RequestID = requestid)\n");
		definitions_map.put("listTenLoanRequest", "rs:Set(LoanRequest) = LoanRequest.allInstance()->select(r:LoanRequest | r.Status =  LoanRequestStatus :: REFERENCESVALIDATED)\n");
		definitions_map.put("chooseOneForReview", "rs:LoanRequest = self.CurrentLoanRequests->any(r:LoanRequest | r.RequestID = requestid)\n");
		definitions_map.put("addLoanTerm", "loanterm:LoanTerm = LoanTerm.allInstance()->any(loa:LoanTerm | loa.ItemID = termid)\n");
		definitions_map.put("listApprovalRequest", "rs:Set(LoanRequest) = LoanRequest.allInstance()->select(r:LoanRequest | r.Status =  LoanRequestStatus :: APPROVED)\n");
		definitions_map.put("genereateApprovalLetter", "r:LoanRequest = LoanRequest.allInstance()->any(lr:LoanRequest | lr.RequestID = id)\n");
		...
		definitions_map.put("generateStandardPaymentNotice", "loans:Set(Loan) = Loan.allInstance()->select(loa:Loan | loa.Status = LoanStatus :: LSOPEN and Today.After(3).isAfter(loa.CurrentOverDueDate))\n");
		definitions_map.put("generateLateNotice", "loans:Set(Loan) = Loan.allInstance()->select(loa:Loan | loa.Status = LoanStatus :: LSOPEN and Today.isAfter(loa.CurrentOverDueDate))\n");
		definitions_map.put("loanPayment", "loan:Loan = Loan.allInstance()->any(loa:Loan | loa.LoanID = loanid)\n");
		definitions_map.put("closeOutLoan", "loan:Loan = Loan.allInstance()->any(loa:Loan | loa.LoanID = loanid)\n");
		definitions_map.put("createLoanTerm", "loanterm:LoanTerm = LoanTerm.allInstance()->any(loa:LoanTerm | loa.ItemID = itemid)\n");
		definitions_map.put("queryLoanTerm", "loanterm:LoanTerm = LoanTerm.allInstance()->any(loa:LoanTerm | loa.ItemID = itemid)\n");
		definitions_map.put("modifyLoanTerm", "loanterm:LoanTerm = LoanTerm.allInstance()->any(loa:LoanTerm | loa.ItemID = itemid)\n");
		definitions_map.put("deleteLoanTerm", "loanterm:LoanTerm = LoanTerm.allInstance()->any(loa:LoanTerm | loa.ItemID = itemid)\n");
		...
		postconditions_map.put("getCheckingAccountStatus", "true");
		postconditions_map.put("getCreditHistory", "true");
		postconditions_map.put("sendEmail", "true");
		postconditions_map.put("print", "true");
		postconditions_map.put("createLoanAccount", "true");
		postconditions_map.put("transferFunds", "true");
	...
	*/			
	...
	public void bookNewLoan() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: bookNewLoan in service: LoanManagementModule ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(loanmanagementmodule_service.bookNewLoan(
	...
	public void generateStandardPaymentNotice() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: generateStandardPaymentNotice in service: LoanManagementModule ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(loanmanagementmodule_service.generateStandardPaymentNotice(
			));	
			Label l = new Label(result);
			l.setPadding(new Insets(8, 8, 8, 8));
			operation_return_pane.setContent(l);
	...
	public void generateLateNotice() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: generateLateNotice in service: LoanManagementModule ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(loanmanagementmodule_service.generateLateNotice(
			));	
			Label l = new Label(result);
			l.setPadding(new Insets(8, 8, 8, 8));
			operation_return_pane.setContent(l);
	...
	public void loanPayment() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: loanPayment in service: LoanManagementModule ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(loanmanagementmodule_service.loanPayment(
	...
	public void closeOutLoan() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: closeOutLoan in service: LoanManagementModule ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(loanmanagementmodule_service.closeOutLoan(
	...
	public void getCheckingAccountStatus() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: getCheckingAccountStatus in service: ThirdPartServices ");
		
		try {
			//invoke op with parameters
				CheckingAccount r = thirdpartservices_service.getCheckingAccountStatus(
	...
	public void getCreditHistory() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: getCreditHistory in service: ThirdPartServices ");
		
		try {
			//invoke op with parameters
				CreditHistory r = thirdpartservices_service.getCreditHistory(
	...
	public void sendEmail() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: sendEmail in service: ThirdPartServices ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(thirdpartservices_service.sendEmail(
	...
	public void print() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: print in service: ThirdPartServices ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(thirdpartservices_service.print(
	...
	public void createLoanAccount() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: createLoanAccount in service: ThirdPartServices ");
		
		try {
			//invoke op with parameters
				LoanAccount r = thirdpartservices_service.createLoanAccount(
	...
	public void transferFunds() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: transferFunds in service: ThirdPartServices ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(thirdpartservices_service.transferFunds(
	...
	LoanManagementModule loanmanagementmodule_service;
