...
public class PrototypeController implements Initializable {
	...
	*/
	public void genereateOpInvariantPanel() {
		...
		//entities invariants
		entities = CoCoMEProcessSaleImpl.opINVRelatedEntity.get("openStore");
		if (entities != null) {
		...
		//entities invariants
		entities = CoCoMEProcessSaleImpl.opINVRelatedEntity.get("closeStore");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = CoCoMEProcessSaleImpl.opINVRelatedEntity.get("openCashDesk");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = CoCoMEProcessSaleImpl.opINVRelatedEntity.get("closeCashDesk");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = ThirdPartServicesImpl.opINVRelatedEntity.get("thirdPartyCardPaymentService");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
	...
	*/ 
	...
	public void prepareData() {
		...
		definitions_map.put("openStore", "\rsto:Store = Store.allInstance()->any(s:Store | s.Id = storeID)\n");
		definitions_map.put("closeStore", "\rsto:Store = Store.allInstance()->any(s:Store | s.Id = storeID)\n");
		definitions_map.put("openCashDesk", "\rcd:CashDesk = CashDesk.allInstance()->any(s:CashDesk | s.Id = cashDeskID)\n");
		definitions_map.put("closeCashDesk", "\rcd:CashDesk = CashDesk.allInstance()->any(s:CashDesk | s.Id = cashDeskID)\n");
		definitions_map.put("enterItem", "\ritem:Item = Item.allInstance()->any(i:Item | i.Barcode = barcode)\n");
		definitions_map.put("orderItem", "\ritem:Item = Item.allInstance()->any(i:Item | i.Barcode = barcode)\n");
		definitions_map.put("chooseSupplier", "\rsup:Supplier = Supplier.allInstance()->any(s:Supplier | s.Id = supplierID)\n");
		definitions_map.put("changePrice", "\ritem:Item = Item.allInstance()->any(i:Item | i.Barcode = barcode)\n");
		definitions_map.put("receiveOrderedProduct", "\rop:OrderProduct = OrderProduct.allInstance()->any(i:OrderProduct | i.Id = orderID)\n");
		...
		preconditions_map.put("openStore", "\rsto.oclIsUndefined() = false and\nsto.IsOpened = false\n");
		preconditions_map.put("closeStore", "\rsto.oclIsUndefined() = false and\nsto.IsOpened = true\n");
		preconditions_map.put("openCashDesk", "\rcd.oclIsUndefined() = false and\ncd.IsOpened = false and\ncurrentStore.oclIsUndefined() = false and\ncurrentStore.IsOpened = true\n");
		preconditions_map.put("closeCashDesk", "\rcd.oclIsUndefined() = false and\ncd.IsOpened = true and\ncurrentStore.oclIsUndefined() = false and\ncurrentStore.IsOpened = true\n");
		preconditions_map.put("makeNewSale", "\rcurrentCashDesk.oclIsUndefined() = false and\ncurrentCashDesk.IsOpened = true and\n(currentSale.oclIsUndefined() = true or\n\t(currentSale.oclIsUndefined() = false and\n\t\tcurrentSale.IsComplete = true\n\t)\n)\n");
		preconditions_map.put("enterItem", "\rcurrentSale.oclIsUndefined() = false and\ncurrentSale.IsComplete = false and\nitem.oclIsUndefined() = false and\nitem.StockNumber > 0\n");
		preconditions_map.put("endSale", "\rcurrentSale.oclIsUndefined() = false and\ncurrentSale.IsComplete = false and\ncurrentSale.IsReadytoPay = false\n");
		preconditions_map.put("makeCashPayment", "\rcurrentSale.oclIsUndefined() = false and\ncurrentSale.IsComplete = false and\ncurrentSale.IsReadytoPay = true and\namount >= currentSale.Amount\n");
		preconditions_map.put("makeCardPayment", "\rcurrentSale.oclIsUndefined() = false and\ncurrentSale.IsComplete = false and\ncurrentSale.IsReadytoPay = true and\nthirdPartyCardPaymentService(cardAccountNumber , expiryDate , fee)\n");
		preconditions_map.put("thirdPartyCardPaymentService", "\rtrue");
		preconditions_map.put("makeNewOrder", "\rtrue");
		preconditions_map.put("listAllOutOfStoreProducts", "\rtrue");
		preconditions_map.put("orderItem", "\ritem.oclIsUndefined() = false");
		preconditions_map.put("chooseSupplier", "\rsup.oclIsUndefined() = false and\ncurrentOrderProduct.oclIsUndefined() = false\n");
		preconditions_map.put("placeOrder", "\rcurrentOrderProduct.oclIsUndefined() = false");
		preconditions_map.put("changePrice", "\ritem.oclIsUndefined() = false");
		preconditions_map.put("receiveOrderedProduct", "\rop.oclIsUndefined() = false");
		preconditions_map.put("listSuppliers", "\rtrue");
		preconditions_map.put("showStockReports", "\rtrue");
		...
		postconditions_map.put("openStore", "\r\n\t\tself.currentStore = sto and\nsto.IsOpened = true and\nresult = true\n");
		postconditions_map.put("closeStore", "\r\n\t\tsto.IsOpened = false and\nresult = true\n");
		postconditions_map.put("openCashDesk", "\r\n\t\tself.currentCashDesk = cd and\ncd.IsOpened = true and\nresult = true\n");
		postconditions_map.put("closeCashDesk", "\r\n\t\tself.currentCashDesk = cd and\ncd.IsOpened = false and\nresult = true\n");
		...
		postconditions_map.put("createSupplier", "let sup:Supplier in\nsup.oclIsNew() and\nsup.Id = id and\nsup.Name = name and\nSupplier.allInstance()->includes(sup) and\nresult = true\n");
	...
	*/			
	...
	public void openStore() {
		...
		log.appendText(time + " -- execute operation: openStore in service: CoCoMEProcessSale ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(cocomeprocesssale_service.openStore(
	...
	public void closeStore() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: closeStore in service: CoCoMEProcessSale ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(cocomeprocesssale_service.closeStore(
	...
	public void openCashDesk() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: openCashDesk in service: CoCoMEProcessSale ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(cocomeprocesssale_service.openCashDesk(
	...
	public void closeCashDesk() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: closeCashDesk in service: CoCoMEProcessSale ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(cocomeprocesssale_service.closeCashDesk(
	...
	public void thirdPartyCardPaymentService() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: thirdPartyCardPaymentService in service: ThirdPartServices ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(thirdpartservices_service.thirdPartyCardPaymentService(
