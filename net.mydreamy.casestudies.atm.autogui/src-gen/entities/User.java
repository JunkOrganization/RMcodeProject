...
public class User implements Serializable {
	...
	private List<Transcation> HasTrans = new LinkedList<Transcation>(); 
	...
	public List<Transcation> getHasTrans() {
		return HasTrans;
	}	
	
	public void addHasTrans(Transcation transcation) {
		this.HasTrans.add(transcation);
	}
	
	public void deleteHasTrans(Transcation transcation) {
		this.HasTrans.remove(transcation);
	}
