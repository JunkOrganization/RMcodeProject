...
public class BankCard implements Serializable {
	...
	private List<Transcation> Has = new LinkedList<Transcation>(); 
	...
	public List<Transcation> getHas() {
		return Has;
	}	
	
	public void addHas(Transcation transcation) {
		this.Has.add(transcation);
	}
	
	public void deleteHas(Transcation transcation) {
		this.Has.remove(transcation);
	}
