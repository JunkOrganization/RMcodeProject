...
public class PrototypeController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		librarymanagementsystem_service = ServiceManager.createLibraryManagementSystem();
	...
	*/
	public void genereateOpInvariantPanel() {
		...
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("makeReservation");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		for (Entry<String, String> inv : service_invariants_map.entrySet()) {
			...
			if (serviceName.equals("LibraryManagementSystem")) {
				Label l = new Label(invname);
				l.setStyle("-fx-max-width: Infinity;" + 
						   "-fx-background-color: linear-gradient(to right, #7FFF00 0%, #F0FFFF 100%);" +
						   "-fx-padding: 6px;" +
		...
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("cannelReservation");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
			...
			Label l = new Label("cannelReservation" + " is no related invariants");
			l.setPadding(new Insets(8, 8, 8, 8));
			v.getChildren().add(l);
		}
		...
		opInvariantPanel.put("cannelReservation", v);
		
		v = new VBox();
		
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("borrowBook");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("returnBook");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("renewBook");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("payOverDueFee");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("dueSoonNotification");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("checkOverDueandComputeOverDueFee");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("countDownSuspensionDay");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = LibraryManagementSystemImpl.opINVRelatedEntity.get("recommendBook");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
		...
		//entities invariants
		entities = ThirdPartServicesImpl.opINVRelatedEntity.get("sendNotificationEmail");
		if (entities != null) {
			for (String opRelatedEntities : entities) {				
				for (Entry<String, String> inv : entity_invariants_map.entrySet()) {
	...
	*/ 
	...
	public void prepareData() {
		...
		postconditions_map.put("dueSoonNotification", "let users:Set(User) = User.allInstance()->select(user:User | user.LoanedBook->exists(loan:Loan | loan.IsReturned = false and Today.After(3).isAfter(loan.DueDate))) in\nusers->forAll(u:User |\n\tsendNotificationEmail(u.Email))\n");
		...
		postconditions_map.put("countDownSuspensionDay", "let users:Set(User) = User.allInstance()->select(u:User | u.SuspensionDays > 0) in\nusers->forAll(u:User |\n\tu.SuspensionDays = u.SuspensionDays@pre - 1 and\n\tif\n\t\tu.BorrowStatus = BorrowStatus::SUSPEND and\n\t\tu.OverDueFee = 0 and\n\t\tu.SuspensionDays = 0\n\tthen\n\t\tu.BorrowStatus = BorrowStatus::NORMAL\n\tendif\n)\n");
		...
		postconditions_map.put("createSubject", "let sub:Subject in\nsub.oclIsNew() and\nsub.Name = name and\nSubject.allInstance()->includes(sub) and\nresult = true\n");
	...
	public void generatOperationPane() {
		 ...
		 // ==================== GridPane_cannelReservation ====================
		 GridPane cannelReservation = new GridPane();
		 cannelReservation.setHgap(4);
		 cannelReservation.setVgap(6);
		 cannelReservation.setPadding(new Insets(8, 8, 8, 8));
		 
		 ObservableList<Node> cannelReservation_content = cannelReservation.getChildren();
		 Label cannelReservation_uid_label = new Label("uid:");
		 cannelReservation_uid_label.setMinWidth(Region.USE_PREF_SIZE);
		 cannelReservation_content.add(cannelReservation_uid_label);
		 GridPane.setConstraints(cannelReservation_uid_label, 0, 0);
		 
		 cannelReservation_uid_t = new TextField();
		 cannelReservation_content.add(cannelReservation_uid_t);
		 cannelReservation_uid_t.setMinWidth(Region.USE_PREF_SIZE);
		 GridPane.setConstraints(cannelReservation_uid_t, 1, 0);
		 Label cannelReservation_barcode_label = new Label("barcode:");
		 cannelReservation_barcode_label.setMinWidth(Region.USE_PREF_SIZE);
		 cannelReservation_content.add(cannelReservation_barcode_label);
		 GridPane.setConstraints(cannelReservation_barcode_label, 0, 1);
		 
		 cannelReservation_barcode_t = new TextField();
		 cannelReservation_content.add(cannelReservation_barcode_t);
		 cannelReservation_barcode_t.setMinWidth(Region.USE_PREF_SIZE);
		 GridPane.setConstraints(cannelReservation_barcode_t, 1, 1);
		 operationPanels.put("cannelReservation", cannelReservation);
	...
	*/
	...
	public void execute(ActionEvent event) {
		...
		case "cannelReservation" : cannelReservation(); break;
	...
	*/			
	...
	public void makeReservation() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: makeReservation in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(librarymanagementsystem_service.makeReservation(
	...
	public void cannelReservation() {
		
		System.out.println("execute cannelReservation");
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: cannelReservation in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(librarymanagementsystem_service.cannelReservation(
			cannelReservation_uid_t.getText(),
			cannelReservation_barcode_t.getText()
			));	
			Label l = new Label(result);
			l.setPadding(new Insets(8, 8, 8, 8));
			operation_return_pane.setContent(l);
	...
	public void borrowBook() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: borrowBook in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(librarymanagementsystem_service.borrowBook(
	...
	public void returnBook() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: returnBook in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(librarymanagementsystem_service.returnBook(
	...
	public void renewBook() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: renewBook in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(librarymanagementsystem_service.renewBook(
	...
	public void payOverDueFee() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: payOverDueFee in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(librarymanagementsystem_service.payOverDueFee(
	...
	public void dueSoonNotification() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: dueSoonNotification in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//no return type
			librarymanagementsystem_service.dueSoonNotification(
			);	
	...
	public void checkOverDueandComputeOverDueFee() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: checkOverDueandComputeOverDueFee in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//no return type
			librarymanagementsystem_service.checkOverDueandComputeOverDueFee(
			);	
	...
	public void countDownSuspensionDay() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: countDownSuspensionDay in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//no return type
			librarymanagementsystem_service.countDownSuspensionDay(
			);	
	...
	public void recommendBook() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: recommendBook in service: LibraryManagementSystem ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(librarymanagementsystem_service.recommendBook(
	...
	public void sendNotificationEmail() {
		...
		String time = String.format("%1$tH:%1$tM:%1$tS", System.currentTimeMillis());
		log.appendText(time + " -- execute operation: sendNotificationEmail in service: ThirdPartServices ");
		
		try {
			//invoke op with parameters
			//return value is primitive type, bind result to label.
			String result = String.valueOf(thirdpartservices_service.sendNotificationEmail(
	...
	LibraryManagementSystem librarymanagementsystem_service;
	...
	TextField cannelReservation_uid_t;
	TextField cannelReservation_barcode_t;
